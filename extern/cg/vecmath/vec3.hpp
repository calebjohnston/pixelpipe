...
public:
    ...
    // This is now a standard constructor, except when compiling legacy MixKit code.
    template<class U> TVec3(const U v[3]) { elt[0]=v[0]; elt[1]=v[1]; elt[2]=v[2]; }
